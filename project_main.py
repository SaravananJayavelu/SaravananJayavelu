...
def payment_count_year(sel_year):
    ...
    fig_apc= px.bar(apc3,x= "Transaction_type", y= "Transaction_count", title= "TRANSACTION TYPE & TRANSACTION COUNT",
...
def payment_amount_year(sel_year):
    ...
    fig_apay= px.bar(apay3, x="Transaction_type", y= "Transaction_amount", title= "TRANSACTION TYPE & TRANSACTION AMOUNT",
...
def reg_state_all_RU(sel_year,state):
    ...
    fig_mus.update_layout(width= 550, height= 500)
...
def reg_state_all_TA(sel_year,state):
    ...
    fig_mts.update_layout(width= 550, height= 500)
...
def ques9():
    ...
    fig_lts= px.pie(ht2, names= "States", values= "Transaction_amount",title= "HIGHEST TRANSACTION AMOUNT and STATES",
                    color_discrete_sequence= px.colors.sequential.Oranges_r)
    return st.plotly_chart(fig_lts)
...
with tab1:
    ...
    with col1:
        st.header("PHONEPE","https://www.phonepe.com/")
    ...
    with col2:
        st.video("C:/Users/Lenovo/Desktop/Phonepe/Video.mp4")
    ...
    with col4:
        ...
        st.write("**-> International Travel Insurance**")
...
with tab2:
    ...
    if sel_year == "All" :
        ...
        with col2:
            ...
            sel_year = st.selectbox("select the Year",("2018", "2019", "2020", "2021", "2022", "2023"))
...
#use below to run the code the streamlit 
# python -m streamlit run "C:\Users\Lenovo\Desktop\Phonepe\venv\project_main.py"